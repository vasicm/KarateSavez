 ...
 */
@Embeddable
public class EkipnoIzvodjenjeKatePK implements Serializable {
    ...
    public EkipnoIzvodjenjeKatePK() {
    }

    public EkipnoIzvodjenjeKatePK(int iDEkipe, int iDTakmicenja, int iDKategorije) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EkipnoIzvodjenjeKatePK)) {
            return false;
        }
        EkipnoIzvodjenjeKatePK other = (EkipnoIzvodjenjeKatePK) object;
    ...
    public String toString() {
        return "mydesignwkc.jpa.entity.EkipnoIzvodjenjeKatePK[ iDEkipe=" + iDEkipe + ", iDTakmicenja=" + iDTakmicenja + ", iDKategorije=" + iDKategorije + " ]";
    }
