 ...
 */
@Embeddable
public class IzvodjenjeKatePK implements Serializable {
    ...
    public IzvodjenjeKatePK() {
    }

    public IzvodjenjeKatePK(int iDTakmicenja, long jmb, int iDKategorije) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IzvodjenjeKatePK)) {
            return false;
        }
        IzvodjenjeKatePK other = (IzvodjenjeKatePK) object;
    ...
    public String toString() {
        return "mydesignwkc.jpa.entity.IzvodjenjeKatePK[ iDTakmicenja=" + iDTakmicenja + ", jmb=" + jmb + ", iDKategorije=" + iDKategorije + " ]";
    }
