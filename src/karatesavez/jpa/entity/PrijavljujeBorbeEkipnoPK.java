 ...
 */
@Embeddable
public class PrijavljujeBorbeEkipnoPK implements Serializable {
    ...
    public PrijavljujeBorbeEkipnoPK() {
    }

    public PrijavljujeBorbeEkipnoPK(int iDEkipe, int iDTakmicenja, int iDKategorije) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrijavljujeBorbeEkipnoPK)) {
            return false;
        }
        PrijavljujeBorbeEkipnoPK other = (PrijavljujeBorbeEkipnoPK) object;
    ...
    public String toString() {
        return "mydesignwkc.jpa.entity.PrijavljujeBorbeEkipnoPK[ iDEkipe=" + iDEkipe + ", iDTakmicenja=" + iDTakmicenja + ", iDKategorije=" + iDKategorije + " ]";
    }
